    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(session.getAttribute("LOGIN_USER")!=null){
                ...
                request.setAttribute("MESSAGE", "You have chosen "+ cart.getCart().get(proId).getQuantity()+" ["+product.getName()+"] successfully <3");
            }else{
                request.setAttribute("MESSAGE", "You must login with user acconut to Add item to cart!");
            }
